...
//点击事件
	...
	public void drag(String locator,String target) {
		WebElement originalelement = finder.findElement(locator);
		WebElement targetelement = finder.findElement(target);
		action.clickAndHold(originalelement).moveToElement(targetelement).release().build().perform();
